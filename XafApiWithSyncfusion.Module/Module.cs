...
namespace XafApiWithSyncfusion.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class XafApiWithSyncfusionModule : ModuleBase {
    public XafApiWithSyncfusionModule() {
		// 
		// XafApiWithSyncfusionModule
		// 
