...
using XafApiWithSyncfusion.Module.BusinessObjects;

namespace XafApiWithSyncfusion.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
    ...
    public override void UpdateDatabaseAfterUpdateSchema() {
        ...
        if (ObjectSpace.GetObjectsCount(typeof(Document), null) == 0) 
        { 
            for (int i = 0; i<300; i++)
            {
                Document document = ObjectSpace.CreateObject<Document>();
                document.Name = $"TEST {i}";
                document.Save();
            }
